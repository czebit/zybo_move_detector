...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M_AXIS_DEBUG" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_M_AXIS_FIFO_DEPTH" -parent ${Page_0}
  ...
  #Adding Page
  set FIFO_PARAMS [ipgui::add_page $IPINST -name "FIFO PARAMS"]
  ipgui::add_param $IPINST -name "HAS_FIFO_NOT_FULL" -parent ${FIFO_PARAMS}
  ipgui::add_param $IPINST -name "HAS_FIFO_NOT_EMPTY" -parent ${FIFO_PARAMS}
  ipgui::add_param $IPINST -name "HAS_FIFO_NOT_ALMOST_EMPTY" -parent ${FIFO_PARAMS}
  ipgui::add_param $IPINST -name "HAS_FIFO_ALMOST_FULL" -parent ${FIFO_PARAMS}
  ipgui::add_param $IPINST -name "HAS_FIFO_ALMOST_EMPTY" -parent ${FIFO_PARAMS}
  ipgui::add_param $IPINST -name "HAS_FIFO_EMPTY" -parent ${FIFO_PARAMS}
  ipgui::add_param $IPINST -name "HAS_FIFO_FULL" -parent ${FIFO_PARAMS}
  ipgui::add_param $IPINST -name "HAS_FIFO_NOT_ALMOST_FULL" -parent ${FIFO_PARAMS}


}

proc update_PARAM_VALUE.C_M_AXIS_DEBUG { PARAM_VALUE.C_M_AXIS_DEBUG } {
	# Procedure called to update C_M_AXIS_DEBUG when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_AXIS_DEBUG { PARAM_VALUE.C_M_AXIS_DEBUG } {
	# Procedure called to validate C_M_AXIS_DEBUG
	return true
}

proc update_PARAM_VALUE.C_M_AXIS_FIFO_DEPTH { PARAM_VALUE.C_M_AXIS_FIFO_DEPTH } {
	# Procedure called to update C_M_AXIS_FIFO_DEPTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_AXIS_FIFO_DEPTH { PARAM_VALUE.C_M_AXIS_FIFO_DEPTH } {
	# Procedure called to validate C_M_AXIS_FIFO_DEPTH
	return true
}
...
proc update_MODELPARAM_VALUE.C_M_AXIS_FIFO_DEPTH { MODELPARAM_VALUE.C_M_AXIS_FIFO_DEPTH PARAM_VALUE.C_M_AXIS_FIFO_DEPTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_AXIS_FIFO_DEPTH}] ${MODELPARAM_VALUE.C_M_AXIS_FIFO_DEPTH}
}
...
proc update_MODELPARAM_VALUE.C_M_AXIS_DEBUG { MODELPARAM_VALUE.C_M_AXIS_DEBUG PARAM_VALUE.C_M_AXIS_DEBUG } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_AXIS_DEBUG}] ${MODELPARAM_VALUE.C_M_AXIS_DEBUG}
}
