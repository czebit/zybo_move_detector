...
create_clock -period 13.468 -name TMDS_clk_p -waveform {0.000 6.734} [get_ports TMDS_clk_p]
...
create_clock -period 13.468 -waveform {0.000 6.734} [get_nets hdmi_in_i/axi_dynclk_0_PXL_CLK_O]
