...
#
# Generated by Vivado on Fri Sep 23 00:48:38 +0200 2022
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/srcs/ZYBO_Master.xdc"]"\
  ]
  foreach ifile $files {
...
set file "[file normalize "$origin_dir/srcs/ZYBO_Master.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "srcs/ZYBO_Master.xdc"
...
set_property -name "target_constrs_file" -value "[get_files *srcs/ZYBO_Master.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *srcs/ZYBO_Master.xdc]" -objects $obj
...
proc cr_bd_hdmi_in { parentCell } {
  ...
  xilinx.com:user:sigma_delta:1.0\
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FPGA3_PERIPHERAL_FREQMHZ {142} \
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  set sigma_delta_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:sigma_delta:1.0 sigma_delta_0 ]
  set_property -dict [ list \
   CONFIG.T {20} \
 ] $sigma_delta_0
  ...
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXIS_MM2S [get_bd_intf_pins axi_vdma_0/M_AXIS_MM2S] [get_bd_intf_pins sigma_delta_0/S_AXIS_VM]
  ...
  connect_bd_intf_net -intf_net axi_vdma_1_M_AXIS_MM2S [get_bd_intf_pins axi_vdma_1/M_AXIS_MM2S] [get_bd_intf_pins sigma_delta_0/S_AXIS_FRAME]
  ...
  connect_bd_intf_net -intf_net sigma_delta_0_M_AXIS_MASK [get_bd_intf_pins sigma_delta_0/M_AXIS_MASK] [get_bd_intf_pins v_axi4s_vid_out_0/video_in]
  connect_bd_intf_net -intf_net sigma_delta_0_M_AXIS_VM [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM] [get_bd_intf_pins sigma_delta_0/M_AXIS_VM]
  ...
  connect_bd_net -net Net [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins rst_processing_system7_0_150M/peripheral_aresetn] [get_bd_pins sigma_delta_0/m_axis_vm_arstn] [get_bd_pins sigma_delta_0/s_axis_vm_arstn]
  connect_bd_net -net axi_dynclk_0_LOCKED_O [get_bd_pins axi_dynclk_0/LOCKED_O] [get_bd_pins sigma_delta_0/m_axis_mask_arstn] [get_bd_pins sigma_delta_0/reset_n] [get_bd_pins sigma_delta_0/s_axis_frame_arstn] [get_bd_pins y_to_gs_rgb_0/reset_n]
  connect_bd_net -net axi_dynclk_0_PXL_CLK_O [get_bd_pins axi_dynclk_0/PXL_CLK_O] [get_bd_pins axi_vdma_1/m_axis_mm2s_aclk] [get_bd_pins rgb2vga_0/PixelClk] [get_bd_pins sigma_delta_0/clk] [get_bd_pins sigma_delta_0/m_axis_mask_aclk] [get_bd_pins sigma_delta_0/s_axis_frame_aclk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/clk] [get_bd_pins y_to_gs_rgb_0/pixel_clk]
  ...
  connect_bd_net -net axi_vdma_1_mm2s_frame_ptr_out [get_bd_pins axi_vdma_0/mm2s_frame_ptr_in] [get_bd_pins axi_vdma_1/mm2s_frame_ptr_out]
  connect_bd_net -net axi_vdma_1_s2mm_frame_ptr_out [get_bd_pins axi_vdma_0/s2mm_frame_ptr_in] [get_bd_pins axi_vdma_1/s2mm_frame_ptr_out]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_1/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_1/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_1/s_axis_s2mm_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_processing_system7_0_150M/slowest_sync_clk] [get_bd_pins sigma_delta_0/m_axis_vm_aclk] [get_bd_pins sigma_delta_0/s_axis_vm_aclk] [get_bd_pins v_vid_in_axi4s_0/aclk]
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z010clg400-1 -flow {Vivado Implementation 2021} -strategy "Performance_Auto_2" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
  set_property strategy "Performance_Auto_2" [get_runs impl_1]
...
set obj [get_runs impl_1]
set_property -name "constrset" -value "constrs_1" -objects $obj
set_property -name "description" -value "Second best predicted directive for place_design." -objects $obj
